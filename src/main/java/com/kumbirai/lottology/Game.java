...
public enum Game
{
    LOTTO("lotto.xlsx", "lottoPredictions.txt", "lotto", 6, 5),
    POWERBALL("powerball.xlsx", "powerballPredictions.txt", "powerball", 5, 5);
    ...
    /**
     * Constructor: @param fileName Constructor: @param predictionsFile Constructor: @param folder Constructor: @param columns Constructor: @param startRow
     */
